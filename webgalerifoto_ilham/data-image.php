...
<body>
    ...
    <header>
        <div class="container">
        <h1><a href="dashboard.php"><span style="color:black;">GALERI </span>FOTO</a></h1>
        <ul>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
                <p><a href="tambah-image.php" class="button-add">Tambah Data</a></p>
                <table border="1" cellspacing="0" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <a href="edit-image.php?id=<?php echo $row['image_id']  ?>" class="button-edit">Edit</a>
                              <a href="proses-hapus.php?idp=<?php echo $row['image_id'] ?>" class="button-del" onclick="return confirm('Yakin Ingin Hapus ?')">Hapus</a>
                           </td>
                        </tr>
                        <?php }}else{ ?>
                             <tr>
